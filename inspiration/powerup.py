...
class Powerup(Item):
    def __init__(self, image_path, tile_size, spawn_points=50, amount=1):
        super().__init__(0, 0, spawn_points)
    ...
    def respawn(self, level_map):
        ...
        if free_positions:
            ...
            self.consumed = False
            print(f"Powerup spawned at ({self.x_coordinate}, {self.y_coordinate})")
        else:
            print("Geen vrije plekken voor powerup!")
