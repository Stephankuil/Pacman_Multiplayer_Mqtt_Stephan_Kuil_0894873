```mermaid 
    ...
    X -->|Ja| Y[Pacman power_mode = False]    
    ...
    BE --> BF[Verwerk cheese_eaten_message]    
    BF --> BG[Verwerk item_eaten_message]   
    BG --> BH[Publiceer world_state]   
    BA -->|Nee| BI{Client heeft world_state?}   
    ...
    BQ --> BR[pygame display flip]    
    BR --> BS[clock tick 10 FPS]    
    BS --> K    
